...
export default function ThankYou() {
    ...
    if (data === false) {
        //still waiting for the stripe webhook to update our database
        return (
            <div className="w-full mt-24 flex justify-center">
                <div className="flex flex-col items-center gap-2">
                    <Loader2 className="size-8 animate-spin text-zinc-500" />
    ...
    return (
        <div className="bg-white">
            <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
                ...
                <div className="mt-10 border-t border-zinc-200">
                    <div className="mt-10 flex flex-auto flex-col">
                        ...
                        <p className="mt-2 text-sm text-zinc-600">
                            We at CaseCobra believe that a phone doesn't only need to look good, but also last you for the years to come. We offer 5-year gaurantee: If your case isn't of the highest quality, we'll replace it for free.
                        </p>
                    </div>
                </div>
                ...
                <div>
                    <div className="grid grid-cols-2 gap-6 py-10 text-sm">
                        <div>
