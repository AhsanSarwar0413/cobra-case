...
import { BASE_PRICE, PRICE } from "@/config/product";
...
export default function DesignPreview({
    ...
    if (material === 'polycarbonate') {
        totalPrice += PRICE.material.polycarbonate;
    }
    if (finish === 'textured') {
        totalPrice += PRICE.finish.textured;
    }
    ...
    return (
        <>
            <div aria-hidden="true" className="pointer-events-none select-none absolute inset-0 overflow-hidden flex justify-center">
                <Confetti active={showConfetti} config={{ elementCount: 200, spread: 900 }} />
            </div>
            ...
            <div className="mt-20 flex flex-col items-center md:grid text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12">
                ...
                <div className="sm:col-span-12 md:col-span-9 text-base">
                            ...
                            <div className="flow-root text-sm">
                                ...
                                {finish === 'textured' && (
                                    <div className="flex items-center justify-between py-1 mt-2">
                                        ...
                                        <p className="font-medium text-gray-900">
                                            {formatPrice(PRICE.finish.textured / 100)}
                                        </p>
                                    </div>
                                )}
                                ...
                                {material === 'polycarbonate' && (
                                    <div className="flex items-center justify-between py-1 mt-2">
                                        ...
                                        <p className="font-medium text-gray-900">
                                            {formatPrice(PRICE.material.polycarbonate / 100)}
                                        </p>
                                    </div>
                                )}
                    ...
                    <div className="mt-8 flex justify-end pb-12">
                        <Button onClick={() => handleCheckout()} className="px-4 sm:px-6 lg:px-8">Check out <ArrowRight className="size-4 ml-1.5 inline" /></Button>
                    </div>
                </div>
            </div>
        </>
